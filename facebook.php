...
$app_id = '1673342496228524';//1359398051
$app_secret = '17d7e57315d776469eab514cf372d1f3' ;
...
//https://graph.facebook.com/v2.3/1359398051/feed?key=value&access_token=344527138960087|5eeb9c5b9d4642177144202c488eb8f6&fields=id,message,picture,link,name,description,type,icon,created_time,from,object_id,likes,comments
//print_r($graphUrl); 
//exit;
// get page details
$pageObject = file_get_contents($graphUrl);
